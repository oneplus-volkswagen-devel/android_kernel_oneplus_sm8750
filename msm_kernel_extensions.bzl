...
# oplus devicetree overlay use oplus dir
load("//msm-kernel/arch/arm64/boot/dts/vendor:oplus/platform_map.bzl", _get_dtb_list = "get_dtb_list", _get_dtbo_list = "get_dtbo_list")
